...
of the Nobel Prize.\endnote{p. 262} However, membership is not always determined
...
membership into the academy.\endnote{p. 262--263} One obstacle stood in the way
...
but also from recognition following his death.\endnote{p. 263} Thus, in the
...
funding.\endnote{p. 38}  These top ten receive 17.9\% of all federal R\&D money
...
limited since its inception.\endnote{p. 39,101}  Over time, America's scientific
...
replacing the pursuit of excellence.''\endnote{p. 34}
...
the change was never made.\endnote{p. 25}
...
into commercial success''\endnote{p. 375}, the scientific research community
...
emphasis should be placed on applied research.\endnote{p. 375--377} The
...
NSF.\endnote{p. 377} As deliberations commenced, suggestions came flooding in
from science and industry---each biased toward their own self
interests.\endnote{p. 386} Tensions within the commission were high, and their
report was released with so many muddled opinions that no single, clear message
could be drawn from it.\endnote{p. 388--389} In order to remedy this problem,
...
manifesto'' titled ``In Support of Basic Research.''\endnote{p. 399} The
document contained exactly zero references to engineering.\endnote{p. 401} As a
...
community---with a vote of 339--58.\endnote{p. 34--35}
...
but not vice-versa.\endnote{p. 45} This view was championed by Vannevar Bush,
...
college dropouts (e.g. Bill Gates and Steve Jobs).\endnote{p. 73} This fact went
unquestioned and the federal budget for science grew to be larger than ever
before.\endnote{p. 488}
...
public.\endnote{p. 411}

University research is funded largely by the federal government, which provided
\$15.5 billion in 1998.\endnote{p. 81} With so much money flowing, some degree
...
and other social events.\endnote{p. 85--86}  As time progressed, these indirect
...
to 46 cents per dollar.\endnote{p. 82}  
...
billion in earmarks between the years of 1980 to 1996.\endnote{p. 184} Compared
...
reviewers.\endnote{p. 185--186} Furthermore, the earmark system is biased
...
Hopkins, and Harvard.''\endnote{p. 189}
...
results of meta-analysis in favor Pfizer.\endnote{p. 350}
